...
export class TelegramBot extends Bot {
    ...
    async sendFile(chatId, filePath, options = {}) {
        ...
        // Grammy 1.40+ rejects a raw string path to InputFile (it tries
        // `'url' in <path>` internally and throws a TypeError on the
        // primitive). Read the file upfront — the 50MB cap enforced by
        // sendFileToUser keeps this bounded.
