...
const [
    ...
    versionedImport("./effects/message-log.js", import.meta),
    versionedImport("./inbox.js", import.meta),
    versionedImport("./effects/inbox-waiter.js", import.meta),
    versionedImport("./effects/spawn-dtach-session.js", import.meta),
    versionedImport("./effects/shell-command.js", import.meta),
    versionedImport("./effects/interval-hook-timer.js", import.meta),
    versionedImport("./effects/interval-hook-run.js", import.meta),
    versionedImport("./effects/access-effect.js", import.meta),
])
...
const effectDispatch = {
    ...
    "send_raw_input_to_claude": dtachOutbound.sendRawInputToClaude,
    // Shim / CLI IPC
    ...
    // access.json bookkeeping
    "record_group_chat":      accessEffect.recordGroupChat,
    // Scheduled tasks
    ...
    // Inter-session message logging
    "log_inter_session_message":      messageLogEffect.logInterSessionMessage,
    // Inbox writes (persistent per-address message store)
    "write_inbox":                    async (effect, _core) => {
        const { address, message } = effect
        if (address && message) {
            await inboxModule.appendInboxMessage(address, message)
        }
    },
    // Event-driven wakeup for cbg ask --sync (see lib/effects/inbox-waiter.js)
    "register_inbox_waiter":          inboxWaiterEffect.registerInboxWaiter,
    "notify_inbox_waiter":            inboxWaiterEffect.notifyInboxWaiter,
    "clear_inbox_waiter":             inboxWaiterEffect.clearInboxWaiterByConn,
    "fail_inbox_waiters_for_session": inboxWaiterEffect.failInboxWaitersForSession,
    // Spawn a fresh dtach-wrapped Claude Code session (used by `cbg new --touch`)
    "spawn_dtach_session":            spawnDtachSessionEffect.spawnDtachSession,
    // `#`-prefix shell commands per topic (zsh -c <cmd>)
    "shell_command_spawn":            shellCommandEffect.spawnShellCommand,
    // Interval hooks
    "interval_hook_timer_set":        intervalHookTimer.intervalHookTimerSet,
    "interval_hook_timer_clear":      intervalHookTimer.intervalHookTimerClear,
    "interval_hook_run":              intervalHookRun.runIntervalHook,
}
...
const handlers = {
    ...
    "scheduled_task_worker_overflow": (await versionedImport("./event-handlers/scheduled-task-worker-overflow.js", import.meta)).default,
    "scheduled_task_rehydrate": (await versionedImport("./event-handlers/scheduled-task-rehydrate.js", import.meta)).default,
    "scheduled_task_stuck_watchdog": (await versionedImport("./event-handlers/scheduled-task-stuck-watchdog.js", import.meta)).default,
    "create_interval_hook": (await versionedImport("./event-handlers/create-interval-hook.js", import.meta)).default,
    "deactivate_interval_hook": (await versionedImport("./event-handlers/deactivate-interval-hook.js", import.meta)).default,
    "interval_hook_fire": (await versionedImport("./event-handlers/interval-hook-fire.js", import.meta)).default,
    "interval_hook_run_complete": (await versionedImport("./event-handlers/interval-hook-run-complete.js", import.meta)).default,
    "interval_hook_rehydrate": (await versionedImport("./event-handlers/interval-hook-rehydrate.js", import.meta)).default,
    "interval_hook_stuck_watchdog": (await versionedImport("./event-handlers/interval-hook-stuck-watchdog.js", import.meta)).default,
    ...
    "bot_chat_member_updated": (await versionedImport("./event-handlers/bot-chat-member.js", import.meta)).default,
    ...
    "long_task_rehydrate": (await versionedImport("./event-handlers/long-task-rehydrate.js", import.meta)).default,
    ...
    "agent_file_watch_result": (await versionedImport("./event-handlers/agent-file-watch-tick.js", import.meta)).default,
    "bot_health_check": (await versionedImport("./event-handlers/bot-health-check.js", import.meta)).default,
