...
export default function handle(event, core) {
    ...
    if (!topicTitle || topicTitle.toLowerCase() === "general") {
        return {
            effects: [{
                ...
                replyTo: makeReplyTo({ chatId, threadId, setBy: "forum-topic-created:reject-general" }),
    ...
    if (matchedSessionId) {
        ...
        return {
            ...
            effects: [{
                type: "send_text_to_user",
                replyTo: makeReplyTo({ chatId, threadId, setBy: "forum-topic-created:bound-session" }),
