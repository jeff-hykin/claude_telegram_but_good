 ...
 */
function criticStatusEffect(task, chatId, text, core) {
    ...
    // Route to CC topic if the worker session is bound to one
    if (core && task?.workerSessionId) {
        const cc = core.chatState?.commandCenter ?? {}
        const threadId = cc.topicMap?.[task.workerSessionId]
