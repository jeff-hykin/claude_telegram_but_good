 ...
 */
function criticStatusEffect(task, chatId, text, setBy) {
    ...
    return {
        ...
        replyTo: makeReplyTo({ chatId, threadId: null, setBy }),
        text,
        options: { parse_mode: "HTML" },
    }
}
