...
const { buildCancelAction, taskCommandLinks } = await versionedImport("../long-task-actions.js", import.meta)
...
function handleTaskCancel(event, core, taskId) {
    ...
    if (!result.ok) {
        return reply(chatId, result.reason)
    }
