...
// is hardcoded here so we don't fork — we resolve the new path,
// validate it exists, and emit a state patch. Everything else is
// dispatched as `shell_command_spawn` to lib/effects/shell-command.js.
