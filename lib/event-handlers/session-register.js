...
export default function handle(event, core) {
    ...
    // Command center: if a command center is active and this session has
    // a title, auto-bind to an existing topic (by title match) or create
    // a new topic via the create_thread effect.
