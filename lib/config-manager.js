...
const DEFAULTS = Object.freeze({
    ...
    // its locked definition of done. Haiku is the default because it's
    // fast and plenty smart for criteria-checking; Sonnet is the
    // automatic overload fallback. Accepts model aliases ("haiku",
    // "sonnet", "opus") or full model ids ("claude-haiku-4-5-20251001",
    // "claude-sonnet-4-6", etc.). Set via `cbg config critic_model ...`.
