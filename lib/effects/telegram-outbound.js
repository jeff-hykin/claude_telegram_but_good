...
export async function sendTextMessageToUser(effect, core) {
    ...
    // Legacy callers that set chatId directly still work but log a warning.
    let chatId
    ...
    // Merge threadId from replyTo into sendOptions (replyTo takes precedence
    // over anything in options to prevent stale threadId bugs).
