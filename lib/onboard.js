...
export async function onboard() {
    ...
    // --- Step 1: dtach ---
    header("①", "Terminal Multiplexer (dtach)")
    if (isDtachInstalled()) {
    ...
    if (!token) {
        ...
        console.log(c.bold.cyan("    https://t.me/BotFather"))
        console.log()
    ...
    if (!claudeCheck.success) {
        ...
        console.log(c.bold.cyan("    https://docs.anthropic.com/en/docs/claude-code"))
        Deno.exit(1)
    }
    ok("Found claude CLI.")
