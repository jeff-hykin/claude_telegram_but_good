...
export async function onboard() {
    ...
    // Determine plugin source — local path if running from file:, otherwise download
    const metaUrl = new URL(".", import.meta.url)
    let pluginSrcDir
    if (metaUrl.protocol === "file:") {
        pluginSrcDir = sibling(import.meta, "..")
    } else {
        // Running from a URL — download the repo into a local directory
...
async function doShimAndVerify(pluginDir) {
    ...
    if (allOk) {
        ...
        console.log()
        console.log(c.dim("  In Telegram:"))
        console.log("    Send " + c.cyan("/list") + " to see all your Claude sessions.")
