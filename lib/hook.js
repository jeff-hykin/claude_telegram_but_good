...
import { IPC_SOCK, dbg, findClaudePidStrict, UNKNOWN_CLAUDE_PID } from "./protocol.js"

// Strict lookup so we never send a guessed/fallback PID to the server.
// If the walk can't find a real claude process, we tag the event with the
// UNKNOWN sentinel so the server's fail-safe path displays it anyway.
